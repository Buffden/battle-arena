 ...
 *
 * <p>
 * This configuration sets up security policies, CORS, and password encoding.
 * </p>
 */
@Configuration
@EnableWebSecurity
public class SecurityConfig {
     ...
     * - /swagger-ui/** and /api-docs/** (Swagger documentation)
     * </p>
     *
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Allow auth endpoints (registration, login)
