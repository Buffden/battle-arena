...
**⚠️ NOTE: This is REFERENCE DOCUMENTATION for Profile Service technical details.**

**For implementation planning, see:**

- EPIC-5: Progression & Competition (uses Profile Service details from this file)

**This phase file contains:**

- Profile Service architecture
- Design patterns (Facade, Strategy, Repository, Proxy)
- API specifications
- Code structure examples
- Technical implementation details
- Stories and tasks for Profile Service
...
## PHASE-3: Profile Service - Technical Reference

### Issue Template:

```
Title: PHASE-3: Profile Service

Description:
## Overview
Implement complete profile management system for user profiles, global score tracking, rank tier calculation, and statistics using Spring Boot. This phase document provides technical reference for the Profile Service (Port 8082) that manages user profiles, tracks global scores (infinite, no level cap), calculates Valorant-style rank tiers based on score ranges, and maintains win/loss statistics. The service follows clean architecture principles and design patterns (Facade, Strategy, Repository, Proxy).
...
### Service Details
Based on [System Architecture](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/HIGH_LEVEL_DESIGN/02-SYSTEM_ARCHITECTURE.md) section 2.2:
...
### Key Components
Based on [Profile Service LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/SERVICES/PROFILE_SERVICE.md):
...
- [Profile Service LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/SERVICES/PROFILE_SERVICE.md) - Complete service design, components, and patterns
- [System Architecture](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/HIGH_LEVEL_DESIGN/02-SYSTEM_ARCHITECTURE.md) - Profile Service overview (section 2.2)
...
- [Auth Service LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/SERVICES/AUTH_SERVICE.md) - OAuth user data (firstName, lastName, pictureUrl) for profile creation
- [Database Design - Users Collection](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/HIGH_LEVEL_DESIGN/06-DATABASE_DESIGN.md) - OAuth user fields (section 1.1) for profile integration
...
## Labels
phase:profile, backend:profile, priority:high
...
Description:
## Epic
Related to #X (PHASE-3 issue number)
...
Based on [Component Design](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/HIGH_LEVEL_DESIGN/03-COMPONENT_DESIGN.md) section 2.1 and [Profile Service LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/SERVICES/PROFILE_SERVICE.md):
...
- [Profile Service LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/SERVICES/PROFILE_SERVICE.md) - Service design and component structure (sections 1-3)
...
phase:profile, backend:profile, feature, priority:high
...
phase:profile, backend:profile, task, priority:high
...
phase:profile, backend:profile, task, priority:medium
...
Based on [Profile Service LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/SERVICES/PROFILE_SERVICE.md) sections 3-5:
...
- [Profile Service LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/SERVICES/PROFILE_SERVICE.md) - Service design and profile retrieval (sections 3.1-3.2, 5.1-5.2)
- [System Architecture](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/HIGH_LEVEL_DESIGN/02-SYSTEM_ARCHITECTURE.md) - Profile Service overview (section 2.2)
- [Database Design](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/HIGH_LEVEL_DESIGN/06-DATABASE_DESIGN.md) - Profiles collection schema (section 1.2)
- [Database Schema LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/DATABASE_SCHEMA.md) - Profile entity model and repository design (section 3.2)
- [Data Flow](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/HIGH_LEVEL_DESIGN/04-DATA_FLOW.md) - Profile update and score update flows
- [Error Handling](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/COMMON/ERROR_HANDLING.md) - Error handling patterns for profile operations
...
- [Profile Service LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/SERVICES/PROFILE_SERVICE.md) - Profile entity design (section 3.8)
- [Database Design](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/HIGH_LEVEL_DESIGN/06-DATABASE_DESIGN.md) - Profiles collection schema (section 1.2)
- [Database Schema LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/DATABASE_SCHEMA.md) - Profile entity model, indexes, and validation (section 3.2)
- **Database ER Diagram:** `https://github.com/Buffden/battle-arena/blob/main/docs/03-DIAGRAMS/exported/er-diagrams/Database%20ER%20Diagram.png`
...
Based on [Profile Service LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/SERVICES/PROFILE_SERVICE.md) section 3.3:
...
- [Profile Service LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/SERVICES/PROFILE_SERVICE.md) - ProfileRepository design (section 3.3, 5.3)
- [Repository Pattern](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/SERVICES/PROFILE_SERVICE.md) - Pattern application (section 4.4)
...
phase:profile, backend:profile, security, priority:high
...
phase:profile, backend:profile, testing, priority:high
...
- [Profile Service LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/SERVICES/PROFILE_SERVICE.md) - Profile update flow
- [Security Architecture](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/HIGH_LEVEL_DESIGN/07-SECURITY_ARCHITECTURE.md) - File upload security

## Labels

phase:profile, backend:profile, feature, task, priority:medium
...
- [Profile Service LLD](https://github.com/Buffden/battle-arena/blob/main/docs/02-ARCHITECTURE/LOW_LEVEL_DESIGN/SERVICES/PROFILE_SERVICE.md) - API design
- SpringDoc OpenAPI documentation

## Labels

phase:profile, backend:profile, documentation, task, priority:medium
...
1. **Create Phase Issue:** Copy the Phase template and create issue (e.g., #X)
2. **Create Story Issues:** Copy story templates, replace `#X` with Phase issue number, replace `#X` with story issue numbers
3. **Create Subtask Issues:** Copy subtask templates, replace `#X` with Story issue number, replace `#X` with Phase issue number
